...
# -*- coding: utf-8 -*-
"""
Created on Wed Sep  6 10:40:22 2023
...
filepath_fil='/Users/arnaudlemaire/ECL/Queens/Experiment/LS/ComptonNewDAQ/50_80d/2SiPM_coincidence_80d_50d_NoCoincBoard_240nsCoMPASS_CoincidenceWindow_1200_200lsb_15h_raw/FILTERED/SDataF_2SiPM_coincidence_80d_50d_240nsBoard_240nsCoMPASS_CoincidenceWindow_1200_200lsb_15h_raw.CSV'
...
filepath='/Users/arnaudlemaire/ECL/Queens/Experiment/LS/ComptonNewDAQ/50_80d/2SiPM_coincidence_80d_50d_NoCoincBoard_240nsCoMPASS_CoincidenceWindow_1200_200lsb_15h_raw/RAW/SDataR_2SiPM_coincidence_80d_50d_240nsBoard_240nsCoMPASS_CoincidenceWindow_1200_200lsb_15h_raw.CSV'
...
df_fil_0=df_fil[df_fil['CHANNEL']==0]
df_fil_2=df_fil[df_fil['CHANNEL']==2]
df_fil_4=df_fil[df_fil['CHANNEL']==4]
...
###Dataframe des évenements dans les cristaux filtrés
df_NaI_2=df_co2[df_co2['CHANNEL']==2]
df_NaI_4=df_co4[df_co4['CHANNEL']==4]
...
plt.hist(df0['ENERGY'],label="Total",histtype='step', density = d, bins=200)
...
plt.hist(df2['ENERGY'],label="Raw",histtype='step', density = d,bins=200)
plt.hist(df_NaI_2['ENERGY'],label="Coincident",histtype='step', density = d,bins=200)
...
###Channel 4
plt.hist(df4['ENERGY'],label="Raw",histtype='step', density = d,bins=200)
plt.hist(df_NaI_4['ENERGY'],label="Coincident",histtype='step', density = d,bins=200)
...
plt.hist(df_lsc_co2['ENERGY'],histtype='step',density=d,label='ch2_50d', bins=100)
plt.hist(df_lsc_co4['ENERGY'],histtype='step',density=d,label='ch4_80d', bins=100)
plt.hist(df0['ENERGY'],label="Calibration_1200lsb",histtype='step', density = d, bins=150) #Comparaison avec le liquide scintillant sans coincidence
#plt.yscale('log')
plt.xlim(0,700)
plt.ylim(0,0.004)
plt.title('LSC_Energy_Deposition')
plt.legend(loc='best')
plt.xlabel('Energy'); plt.ylabel('Counts_density')
plt.show()
plt.clf()
...
# Channel 2
plt.hist2d(df_lsc_co2['ENERGY'],df_lsc_co2['ENERGY_CO'], bins=[np.linspace(0,600,30),np.linspace(0,3000,30)])
...
# Channel 4
plt.hist2d(df_lsc_co4['ENERGY'],df_lsc_co4['ENERGY_CO'], bins=[np.linspace(0,600,30),np.linspace(0,2500,30)])
...
plt.hist2d(df_lsc_co2['TIME_DIFF'],df_lsc_co2['ENERGY'], bins=[np.linspace(0,240000,30),np.linspace(0,600,30)])
plt.xlabel('Time_difference_between_LSC&CH2'); plt.ylabel('ENERGY')
plt.title('Energy_LSC_versus_Time_difference')
plt.show()
plt.clf()

plt.hist2d(df_lsc_co4['TIME_DIFF'],df_lsc_co4['ENERGY'], bins=[np.linspace(0,240000,30),np.linspace(0,600,30)])
